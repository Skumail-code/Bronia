...
// String manipulation
  ...
  gettingUserData() async {
    await HelperFunctions.getUserEmailFromSF().then((value) {
      setState(() {
        email = value!; // Assign empty string if value is null
      });
    });
    await HelperFunctions.getUserNameFromSF().then((val) {
      setState(() {
        userName = val!; // Assign empty string if val is null
      });
    });
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
              'You have not joined any group, press + icon to create a group or search from top search button.',
              textAlign: TextAlign.center)
        ],
      ),
    );
